...
function About(){
    return (
        <div className="d-flex flex-column align-items-end" style={{backgroundColor : "lightblue"}}>
                ...
                <button type="button" onClick={btnReacts} className="btn btn-primary" style={{marginRight:"30px", marginBottom:"10px"}}>Read More</button>
